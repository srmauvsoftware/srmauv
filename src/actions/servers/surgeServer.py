...
class surgeAction(object):
    ...
    def __init__(self, name):
        ...
        self.setpoint_pub = rospy.Publisher('/scale_setpoint', Float64, queue_size=10)
        self.state_pub = rospy.Publisher('/scale', Float64, queue_size=10)
        self.K = 1
    ...
    def scaleCallback(self, goal):
        ...
        while True:
            ...
            rospy.loginfo('%s : Going to Surge %f with Error : %f',\
                self._ha, \
                goal.time_setpoint, \
            ...
            if goal.time_setpoint < 0:
                ...
                self.currentState = self.currentState + self.K
            elif goal.time_setpoint == self.currentState:
...
if __name__ == '__main__':
      ...
      server = surgeAction(rospy.get_name())
      rospy.spin()
